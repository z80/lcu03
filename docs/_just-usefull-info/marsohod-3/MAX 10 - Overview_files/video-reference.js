...
AlteraVideo.resize=function(c){var g=($(c).is("div"))?$(c):$(c).parent();
var a=g.width();
var d=23;
var b=23;
var i=25;
...
var f=0.3;
var e=(a-(d+b+i));
g.find(".vjs-progress-control").width(e*h);
g.find(".vjs-volume-control").width((e*f));
g.find(".vjs-mute-control").css({right:g.find(".vjs-volume-control").width()+i});
console.log("vid resize $tgt=",g)
};
...
console.log("videojs GA before load");
b.ga();
